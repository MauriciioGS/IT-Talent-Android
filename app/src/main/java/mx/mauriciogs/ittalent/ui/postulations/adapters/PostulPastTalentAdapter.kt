...
class PostulPastTalentAdapter(private val jobsList: List<Job>, val fragment: Fragment): RecyclerView.Adapter<PostulPastTalentAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            fragment.requireActivity().snackbar("NO se pueden abrir procesos pasados").showWarning()
        }
