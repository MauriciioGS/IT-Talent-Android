...
class JobsTalentAdapter(private val jobsList: List<Job>, val fragment: Fragment): RecyclerView.Adapter<JobsTalentAdapter.ViewHolder>() {

    class ViewHolder(val itemBinding: JobForTalentCardBinding): RecyclerView.ViewHolder(itemBinding.root) {
        fun bind(job: Job) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = JobForTalentCardBinding.inflate(inflater, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if(fragment is JobsFragment) fragment.onClickItemTalent(jobsList[position])
        }
